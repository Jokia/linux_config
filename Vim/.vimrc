...
"highlight Search ctermfg=blue ctermbg=cyan
...
let g:python3_host_prog = "ucrt64/bin/python3.exe"
let g:ycm_server_python_interpreter = '/ucrt64/bin/python3.exe'
...
"let execute_current_file = "/ucrt64/bin/python3" . expand( "%:p" )
...
Plug 'python-mode/python-mode', { 'for': '/ucrt/bin/python3.exe', 'branch': 'develop' }
call plug#end()
